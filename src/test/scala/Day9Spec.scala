...
class Day9Spec extends AnyFlatSpec with Matchers {
  "example 1" should "match" in {
    ...
    val s = State(Code(input, 0, 0), Nil)

    import day5.Day5.implicits._

    IntCode5.run(s).unsafeRunSync().state.output.reverse shouldBe List(109,1,204,-1,1001,100,1,100,1008,100,16,101,1006,101,0,99)
  }
